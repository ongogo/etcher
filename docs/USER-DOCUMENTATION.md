...
release type of the current application version. For example,
`ETCHER_FAKE_S3_LATEST_VERSION=2.0.0` will be ignored if you're running a
snapshot build, and viceversa.
